        ...
        <div class="blog-page-wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
                        <div class="article-card bg-transparent p-0 shadow-none">
                            <a class="article-card-img-wrapper" href="/chitiet-tintuc/{{$value->id}}">
                                <img src="{{ explode(",",$value->hinh_anh)[0] }}" alt="img" class="article-card-img rounded">
                            </a>
                            ...
                            <h2 class="article-card-heading heading_18">
                                <a class="heading_18" href="/chitiet-tintuc/{{$value->id}}">
                                    {{$value->tieu_de}}
                                </a>
                            </h2>
                        </div>
