                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><a href="index.html"><img src="/assets_client/images/footer-logo-2.png" alt=""></a></figure>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 footer-column">
    ...
    <div class="footer-bottom">
        <div class="auto-container clearfix">
            <ul class="cart-list pull-left clearfix">
                <li><a href="index.html"><img src="/assets_client/images/resource/card-1.png" alt=""></a></li>
                <li><a href="index.html"><img src="/assets_client/images/resource/card-2.png" alt=""></a></li>
                <li><a href="index.html"><img src="/assets_client/images/resource/card-3.png" alt=""></a></li>
                <li><a href="index.html"><img src="/assets_client/images/resource/card-4.png" alt=""></a></li>
            </ul>
