                        ...
                        <div class="card-body">
                            <form id="formBestSale">
                                <template v-for="(value, key) in dataChuyenMuc">
                                    <template v-if="value.id_danh_muc_cha == 0 && value.is_open == 1">
                                        <table class="table table-bordered ">
                                            <thead>
                                                <tr>
                                                    <th><b>@{{ value.ten_danh_muc }}</b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <template v-for="(v, k) in dataChuyenMuc">
                                                            <template v-if="v.id_danh_muc_cha > 0 && v.is_open == 1 && value.id == v.id_danh_muc_cha">
                                                                <table class="table table-bordered ">
                                                                    <thead>
                                                                        <tr>
                                                                             <th> @{{ v.ten_danh_muc }}</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>
                                                                                <template v-for="(v1, k1) in dataSanPham">
                                                                                    <template v-if="v1.id_danh_muc == v.id">
                                        ...
                                        <div class="accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingOne">
                                                    ...
                                                    v-bind:data-target="'#collapseOneee' + key" aria-expanded="true"
                                                                    ...
                                                                    <template
                                                                        ...
                                                                        <h2 class="accordion-header" id="headingOne">
                                                                            <button class="accordion-button" type="button"
                                                                                ...
                                                                                v-bind:data-target="'#collapseOne'+ k"
                                                                                aria-expanded="false"
                                                                                aria-controls="collapseOne">
                                                                                @{{ v.ten_chuyen_muc }}
                                                                            </button>
                                    ...
                                    <template v-if="value.id_chuyen_muc_cha == 0 && value.tinh_trang == 1">
                                        <div class="accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingOne">
                                                    <button class="accordion-button" type="button" data-toggle="collapse"
                                                        v-bind:data-target="'#collapseOns'+ key" aria-expanded="true"
                                                        aria-controls="collapseOne">
                                                        @{{ value.ten_chuyen_muc }}
                                                    </button>
                                                </h2>
                                                                ...
                                                                <template v-for="(v, k) in dataChuyenMuc">
                                                                    <template
                                                                        ...
                                                                        <h2 class="accordion-header" id="headingOne">
                                                                            <button class="accordion-button" type="button"
                                                                                data-toggle="collapse"
                                                                                v-bind:data-target="'#collapseOnesss'+ k"
                                                                                aria-expanded="false"
                                                                                aria-controls="collapseOne">
                                                                                @{{ v.ten_chuyen_muc }}
                                                                            </button>
