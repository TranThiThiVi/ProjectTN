                        ...
                        <tbody>
                            <template v-for="(v, k) in listTinTuc">
                                <tr>
                                    ...
                                    <td class="align-middle text-wrap">@{{ v.mo_ta_ngan }}</td>
                                    <td class="text-center align-middle">
                                        <button v-on:click="modal = v, hienMoTa()"  data-toggle="modal" data-target="#moTaChiTiet" class="btn btn-primary"><i style="padding-left: 6px" class="fa-sharp fa-solid fa-info"></i></button>
                                    </td>
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <button v-on:click="showUpdate(v)" class="btn btn-info" data-toggle="modal" data-target="#updateModal">Cập Nhật</button>
                                        <button v-on:click="xoaTT = v" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal">Xóa Bỏ</button>
                                    </td>
                                </tr>
                            </template>
                        </tbody>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <button v-on:click="xoaTinTuc()" type="button" class="btn btn-danger" data-dismiss="modal">Xóa Tin</button>
            </div>
          </div>
        </div>
    </div>
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <button v-on:click="capNhatTinTuc()" type="button" class="btn btn-primary" data-dismiss="modal">Cập Nhật</button>
            </div>
          </div>
        </div>
    </div>
