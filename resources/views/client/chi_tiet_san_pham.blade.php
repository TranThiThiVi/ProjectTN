...
@section('noi_dung')
    <main  class="content-for-layout">
        <div id="app1" class="product-page mt-100">
            <div class="container">
                <div class="row">
                        ...
                        <div class="product-details ps-lg-4">
                            ...
                            <form class="product-form" action="#">
                                <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                    ...
                                    @endif
                                    <a href="/client/yeu-thich/{{$value->id}}" class="product-wishlist">
                ...
                <div class="tab-content product-tab-content">
                    ...
                    <div id="preview" class="tab-pane fade">
                        <div class="review-area accordion-parent">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <p class="text-end">{{$value->noi_dung}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                            <br>
                            <button class="text_14 bg-transparent text-decoration-underline write-btn text-end" type="button">Viết bình luận</button>
                            @else
                            <div class="review-header d-flex justify-content-between align-items-center">
                                <p class="text_16">Chưa có bình luận nào</p>
                                <button class="text_14 bg-transparent text-decoration-underline write-btn" type="button">Viết bình luận</button>
                            </div>
                            @endif
                            <div class="review-form-area accordion-child">
                                ...
                                <button type="button" id="addComment" class="position-relative review-submit-btn">GỬI</button>
                            </div>
                        </div>
                    </div>
                </div>
